...
namespace sdp.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{user.UserName} cannot be deleted as this user is associated with some role. If you want to delete this user, please remove the roles associated with user";
                    return View("Error");
                }
            }
        ...
        public async Task<IActionResult> ManageUserRoles(string userId)
        {
            ...
            {
                var roleUserViewModel = new UserRolesViewModel
                {
                    RoleId = role.Id
,
                    RoleName = role.Name
                ...
                roleUserViewModel.IsSelected = await userManager.IsInRoleAsync(user, role.Name);
